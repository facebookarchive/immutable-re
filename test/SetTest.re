    ...
    [
      ...
      it(
        ...
        () => {
          ...
          Set.equals(set1, set1) |> Expect.toBeEqualToTrue;
          let setEqualToSet1 = IntRange.create(~start=0, ~count=200) |> IntRange.toSet;
          Set.equals(set1, setEqualToSet1) |> Expect.toBeEqualToTrue;
          let setSameCountDifferentStartThanSet1 =
            IntRange.create(~start=-10, ~count=200) |> IntRange.toSet;
          Set.equals(set1, setSameCountDifferentStartThanSet1) |> Expect.toBeEqualToFalse;
          let setDifferentCountSameStartAsSet1 =
            IntRange.create(~start=0, ~count=199) |> IntRange.toSet;
          Set.equals(set1, setDifferentCountSameStartAsSet1) |> Expect.toBeEqualToFalse
        }
      ),
      it(
        "isEmpty",

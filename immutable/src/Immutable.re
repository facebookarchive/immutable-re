...
let module IterableInternal = Iterable;
...
let module Iterable = {
  ...
  let concat = Iterable.concat;
  let concatAll = Iterable.concatAll;
  let count = Iterable.count;
  let doOnNext = Iterable.doOnNext;
  let empty = Iterable.empty;
  let filter = Iterable.filter;
  let flatMap = Iterable.flatMap;
  let flatten = Iterable.flatten;
  let forEach = Iterable.forEach;
  let hash = Iterable.hash;
  let hashWith = Iterable.hashWith;
  let map = Iterable.map;
  let reduce = Iterable.reduce;
...
let module KeyedIterable = {
  type t 'k 'v = KeyedIterable.t 'k 'v;

  let count = KeyedIterable.count;
  let doOnNext = KeyedIterable.doOnNext;
  let empty = KeyedIterable.empty;
  let filter = KeyedIterable.filter;
  let flatMap = KeyedIterable.flatMap;
  let forEach = KeyedIterable.forEach;
  let hash = KeyedIterable.hash;
  let hashWith = KeyedIterable.hashWith;
  let keys = KeyedIterable.keys;
  let map = KeyedIterable.map;
  let reduce = KeyedIterable.reduce;
  let toIterable = KeyedIterable.toIterable;
  let values = KeyedIterable.values;
};
...
let module Set = {
  ...
  let toIterable = ImmSet.toIterable;
  let toKeyedIterable = ImmSet.toKeyedIterable;
...
let module Map = {
  ...
  let toIterable = ImmMap.toIterable;
  let toKeyedIterable = ImmMap.toKeyedIterable;
...
let module IntRange = {
  ...
  let toIterable = IntRange.toIterable;
  let toIterableReversed = IntRange.toIterableReversed;
  let toKeyedIterable = IntRange.toKeyedIterable;
  let toKeyedIterableReversed = IntRange.toKeyedIterableReversed;
  let toMap = IntRange.toMap;
  let toSeq = IntRange.toSeq;
  let toSeqReversed = IntRange.toSeqReversed;
...
let module CopyOnWriteArray = {
  ...
  let toIterable = CopyOnWriteArray.toIterable;
  let toIterableReversed = CopyOnWriteArray.toIterableReversed;
  let toKeyedIterable = CopyOnWriteArray.toKeyedIterable;
  let toKeyedIterableReversed = CopyOnWriteArray.toKeyedIterableReversed;
...
let module Deque = {
  ...
  let some = Deque.some;
  let toIterable = Deque.toIterable;
  let toIterableReversed = Deque.toIterableReversed;
...
let module HashSet = {
  ...
  let toKeyedIterable = HashSet.toKeyedIterable;
...
let module IntMap = {
  ...
  let toIterable = IntMap.toIterable;
  let toKeyedIterable = IntMap.toKeyedIterable;
...
let module IntSet = {
  ...
  let toIterable = IntSet.toIterable;
  let toKeyedIterable = IntSet.toKeyedIterable;
...
let module List = {
  ...
  let addFirstAll = IterableInternal.listAddFirstAll;
  ...
  let fromReversed = IterableInternal.listFromReverse;
  ...
  let toIterable = IterableInternal.ofList;
...
let module Option = {
  ...
  let toIterable = Option.toIterable;
...
let module SortedMap = {
  ...
  let toIterable = SortedMap.toIterable;
  let toIterableReversed = SortedMap.toIterableReversed;
  let toKeyedIterable = SortedMap.toKeyedIterable;
  let toKeyedIterableReversed = SortedMap.toKeyedIterableReversed;
  let toMap = SortedMap.toMap;
  let toSeq = SortedMap.toSeq;
  let toSeqReversed = SortedMap.toSeqReversed;
...
let module SortedSet = {
  ...
  let toIterable = SortedSet.toIterable;
  let toIterableReversed = SortedSet.toIterableReversed;
  let toKeyedIterable = SortedSet.toKeyedIterable;
  let toKeyedIterableReversed = SortedSet.toKeyedIterableReversed;
  let toSet = SortedSet.toSet;
  let toMap = SortedSet.toMap;
  let toSeq = SortedSet.toSeq;
  let toSeqReversed = SortedSet.toSeqReversed;
...
let module Stack = {
  ...
  let some = Stack.some;
  let toIterable = Stack.toIterable;
...
let module Vector = {
  ...
  let toIterable = Vector.toIterable;
  let toIterableReversed = Vector.toIterableReversed;
  let toKeyedIterable = Vector.toKeyedIterable;
  let toKeyedIterableReversed = Vector.toKeyedIterableReversed;

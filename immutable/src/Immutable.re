...
let module SortedSet = {
  ...
  let maxValue = SortedSet.maxValue;
  let minValue = SortedSet.minValue;
  let none = SortedSet.none;
  let reduce = SortedSet.reduce;
  let reduceRight = SortedSet.reduceRight;
  let remove = SortedSet.remove;
  let removeMax = SortedSet.removeMax;
  let removeMin = SortedSet.removeMin;
  ...
  let tryMaxValue = SortedSet.tryMaxValue;
  let tryMinValue = SortedSet.tryMinValue;

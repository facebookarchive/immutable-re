...
let module Set = {
  ...
  let count = Set.count;
  let empty = Set.empty;
  let equals = Set.equals;
  let every = Set.every;
  let find = Set.find;
  let forEach = Set.forEach;
  let hash = Set.hash;
  let hashWith = Set.hashWith;
  let inRange = Set.inRange;
  let intersect = Set.intersect;
  let isEmpty = Set.isEmpty;
  let isNotEmpty = Set.isNotEmpty;
  let none = Set.none;
  let reduce = Set.reduce;
  let some = Set.some;
  let subtract = Set.subtract;
  let toKeyed = Keyed.ofSet;
  let toSeq = Set.toSeq;
  let tryFind = Set.tryFind;
  let union = Set.union;
};
...
let module Keyed = {
  ...
  let some = Keyed.some;
  let toSet = Keyed.toSet;
  let toSetWith = Keyed.toSetWith;
...
let module Option = {
  ...
  let toSet = SetInternal.ofOption;
  let toSetWith  = SetInternal.ofOptionWith;
